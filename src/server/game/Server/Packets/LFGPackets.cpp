...
WorldPacket const* ReadyCheckResult::Write()
{
...
WorldPacket const* ReadyCheckUpdate::Write()
{
...
WorldPacket const* SlotInvalid::Write()
{
    _worldPacket << Reason;
...
WorldPacket const* RequestPVPRewardsResponse::Write()
{
    ...
    _worldPacket << Rewards[(uint8)BattlegroundBracketType::Arena5v5];
...
WorldPacket const* SetFastLaunchResult::Write()
{
