...
GameTable<GtNpcDamageByClassEntry>               sNpcDamageByClassGameTable[EXPANSION_MISTS_OF_PANDARIA];
GameTable<GtNpcTotalHpEntry>                     sNpcTotalHpGameTable[EXPANSION_MISTS_OF_PANDARIA];
